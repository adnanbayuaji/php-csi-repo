        ...
        <section class="section">
          ...
          <div class="section-body">
            ...
            <div class="card">
              ...
              <?php
                echo form_open('attribute/tambah', 'class="form-horizontal"');
              ?>
              <div class="card-body">
                <div class="row">
                  <div class="col-sm">
                    <div class="form-group">
                      ...
                      <div class="col-sm-12">
                        <?php
                          $attribute = array('name'=>'attribute', 'maxlength'=>'254','value'=>"", 'class'=>'form-control');
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-12">
                      <?php
                          echo form_dropdown('scope', $scope, array(), array('class' => 'form-control'));
