        ...
        <section class="section">
          ...
          <div class="section-body">
            ...
            <div class="card">
              ...
              <?php
                  echo form_open('departemen/update/'.$hasil->dept_id, 'class="form-horizontal"');
              ?>
              <div class="card-body">
                <div class="row">
                  <div class="col-sm">
                    <div class="form-group">
                      ...
                      <div class="col-sm-12">
                        <?php
                            $nama = array('name'=>'nama', 'maxlength'=>'30','value'=>$hasil->dept_nama,'size'=>'30', 'class'=>'form-control');
