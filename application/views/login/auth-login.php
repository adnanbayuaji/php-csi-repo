        ...
        <div class="row">
          <div class="col-12 col-sm-8 offset-sm-2 col-md-6 offset-md-3 col-lg-6 offset-lg-3 col-xl-4 offset-xl-4">
            <div class="login-brand">
              <img src="<?php echo base_url(); ?>assets/img/stisla-fill.png" alt="logo" width="100" class="shadow-light rounded-circle">
            </div>
                  ...
                  <div class="form-group">
                    <div class="d-block">
                      ...
                      <div class="float-right">
                        <a href="<?php echo base_url().'starter/login'; ?>" class="tombol-forgetpass text-small">
                          Forgot Password?
                        </a>
                      </div>
                    </div>
