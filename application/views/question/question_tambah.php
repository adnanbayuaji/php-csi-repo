        ...
        <section class="section">
          ...
          <div class="section-body">
            ...
            <div class="card">
              ...
              <?php
                echo form_open('question/tambah', 'class="form-horizontal"');
              ?>
              <div class="card-body">
                <div class="row">
                  <div class="col-sm">
                    <div class="form-group">
                      ...
                      <div class="col-sm-12">
                      <?php
                          echo form_dropdown('attribute', $attribute, array(), array('class' => 'form-control'));
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-12">
                        <?php
                          $kepentingan = array('name'=>'kepentingan', 'maxlength'=>'254','value'=>"", 'class'=>'form-control');
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-12">
                        <?php
                          $kepuasan = array('name'=>'kepuasan', 'maxlength'=>'254','value'=>"", 'class'=>'form-control');
