...
$this->load->view('_partials/header_user');
?>
      <!-- Main Content -->
          ...
          <div class="col-lg-4">
            <div class="card">
              <div class="card-header">
                <h4>CSI GA Division</h4>
              </div>
              <div class="card-body">
                <div id="okChart" style="height: 200px;"></div>
              </div>
            </div>
          </div>
          <div class="col-lg-8">
            <div class="card">
              <div class="card-header">
                <h4>CSI GA Each Plant</h4>
              </div>
              <div class="card-body">
                <div id="plantChart" style="height: 200px;"></div>
              </div>
            </div>
          </div>
        </div>
          ...
          <div class="col-lg-6">
            <div class="row">
              <div class="col-lg-6">
                <div class="card">
                  ...
                  <div class="card-body">
                    <div id="topChart" style="height: 200px;"></div>
                  </div>
                </div>
              </div>
              <div class="col-lg-6">
                <div class="card">
                  <div class="card-header">
                    <h4>Bottom 3 Average</h4>
                  </div>
                  <div class="card-body">
                    <div id="bottomChart" style="height: 200px;"></div>
                  </div>
                </div>
              </div>
            </div>
            <div class="row">
              <div class="col-lg-12">
                <div class="card">
                  <div class="card-header">
                    <h4>CSI per Departemen</h4>
                  </div>
                  <div class="card-body">
                    <div id="deptChart" style="height: 200px;"></div>
                  </div>
                </div>
              </div>
            </div>
              ...
              <div class="card-body">
                <div class="form-group">
                  <div style="overflow: auto">
                    <table id="exampleVOC" class="table table-striped">
                      <thead>
                        <tr>
                            <th>Deskripsi</th>
                            <th>Jumlah Alasan</th>
                      ...
                      <?php
                          if(!empty($datas_voc))
                          {
                              foreach($datas_voc as $data)
                              {
                                  ?>
                                  <tr>
                                  <td> <label title="<?php echo $data->detail; ?>"><?php echo $data->deskripsi; ?></label></td>
                                  <td> <?php echo $data->alasanb; ?></td>
                                  <td> <?php 
                                    $dataw = array(
                                      'class' => 'btn btn-info btn-sm btn-xs view_data', 
                                      'type' => 'button',
                                      'id' => $data->que_id,
                                      'year'=> $data->years,
